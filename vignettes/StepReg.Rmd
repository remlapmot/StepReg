...
vignette: |
  %\VignetteIndexEntry{StepReg: Stepwise Regression Analysis}
...
You can save the output in different format like "docx", "html", "pptx", and others, facilitating easy sharing. Of note, the suffix will be automatically added to the `report_name`. For instance, the following example generates both "results.xlsx" and "results.docx" reports.
```{r, eval = FALSE}
